...
export default function NewsCard({ news, layout = 'grid' }) {
  if (layout === 'list') {
    return (
    ...
    <Link href={`/news/${news.id}`}>
      <div className="card-hover flex flex-col h-full">
        ...
        <div className="p-6 md:p-8 flex-grow flex flex-col">
          ...
          <h3 className="text-xl font-bold text-slate-900 mb-4 group-hover:text-indigo-700 transition-colors line-clamp-2">
            {news.title}
          </h3>
